...
public class AbstractGFSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Exp6_IntegerTerminalRuleCall_5_1_q;
	...
	protected AbstractElementAlias match_ModBody_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5___or_____AsteriskAsteriskKeyword_0_1_1_or___AsteriskAsteriskKeyword_0_1_1_OpenKeyword_0_2_0_InKeyword_0_2_2___or___OpenKeyword_0_2_0_InKeyword_0_2_2_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5____q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Exp6_IntegerTerminalRuleCall_5_1_q = new TokenAlias(true, false, grammarAccess.getExp6Access().getIntegerTerminalRuleCall_5_1());
		...
		match_ModBody_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5___or_____AsteriskAsteriskKeyword_0_1_1_or___AsteriskAsteriskKeyword_0_1_1_OpenKeyword_0_2_0_InKeyword_0_2_2___or___OpenKeyword_0_2_0_InKeyword_0_2_2_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5____q = new AlternativeAlias(true, false, new GroupAlias(false, false, new AlternativeAlias(false, false, new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getModBodyAccess().getAsteriskAsteriskKeyword_0_1_1()), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getOpenKeyword_0_2_0()), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getInKeyword_0_2_2())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getModBodyAccess().getOpenKeyword_0_2_0()), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getInKeyword_0_2_2())), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getAsteriskAsteriskKeyword_0_1_1())), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getLeftCurlyBracketKeyword_0_3()), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getRightCurlyBracketKeyword_0_5())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getModBodyAccess().getLeftCurlyBracketKeyword_0_3()), new TokenAlias(false, false, grammarAccess.getModBodyAccess().getRightCurlyBracketKeyword_0_5())));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_DataDef_VerticalLineKeyword_2_2_q.equals(syntax))
			...
			else if(match_Exp6_IntegerTerminalRuleCall_5_1_q.equals(syntax))
				emit_Exp6_IntegerTerminalRuleCall_5_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_ModBody_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5___or_____AsteriskAsteriskKeyword_0_1_1_or___AsteriskAsteriskKeyword_0_1_1_OpenKeyword_0_2_0_InKeyword_0_2_2___or___OpenKeyword_0_2_0_InKeyword_0_2_2_____LeftCurlyBracketKeyword_0_3_RightCurlyBracketKeyword_0_5____q.equals(syntax))
				...
				emit_Patt1_AsteriskKeyword_4_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     Integer?
	 */
	protected void emit_Exp6_IntegerTerminalRuleCall_5_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     '*'?
	 */
	protected void emit_Patt1_AsteriskKeyword_4_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
